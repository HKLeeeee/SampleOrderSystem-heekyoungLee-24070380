...
class ProductionCalculatorTest {
    ...
    void isProductionNeeded_sufficientStock_returnsFalse() {
        assertFalse(ProductionCalculator.isProductionNeeded(50, 100));
    }

    @Test
    @DisplayName("부족분 정확히 0 — 주문 100, 재고 100 → 생산 불필요")
    void isProductionNeeded_exactlyZero_returnsFalse() {
    ...
    void calcActualQty_yieldOneBoundary() {
    ...
    void isProductionNeeded_stockExceedsOrder_returnsFalse() {
